...
LOOP AT lt_user_flights INTO DATA(ls_flight).
  ...
  DATA(lv_destination_location) = |{ ls_flight-DestinationCity }, { ls_flight-DestinationCountry }|.
  DATA(lv_departure_location) = |{ ls_flight-DepartureCity }, { ls_flight-DepartureCountry }|.
